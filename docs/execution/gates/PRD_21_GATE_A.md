...
- Record timestamp: `2026-08-31` (landed-evidence refresh only; includes #168)
...
- H4 subject-request scope/intake (#158/#160), append-only steps and completion
  ...
  proof persistence (#173/#183/#188), and retention-preview persistence (#168)
  landed. Retention-rule PG persistence, persisted-preview lookup/transition in
  execution authorization, and full coordinator semantics across these pieces
  remain open; H4 is not closed.
...
- Remaining open residual bands: H4 (retention-rule persistence,
