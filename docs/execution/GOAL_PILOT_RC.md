...
| PRD 07               | `IN_PROGRESS` — synthetic/disposable persistence and TD 007 ports are composed; #192 and the #227 integration add coach-bootstrap/full issue→claim/revoke/resume/abandon PG evidence, transition-sink composition, canonical-input/idempotency guards, trusted-time attempt evaluation, claim-secret throttling, and student/coach onboarding screens. The #227 correction makes throttled responses non-oracular while preserving safe retry replay/mismatch semantics. #246 binds the four PG repository readiness components to real schema evidence, #247 binds clock/id/secret components to real self-tests, and #248 composes the same real mechanism instances into the PG readiness probe. Real-user remains under `LEGAL_PRIVACY`; Gate A is not claimed.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
