...
- Last refreshed: 2026-09-03 (integrated delivery refresh through #261)
- Progress snapshot head: `743bf3c` (PR #261 merged; see Progress)
...
1. Continue remaining PRD 07/21 synthetic/disposable mechanics — #230 landed an
   ...
   that helper. Exact inventory/runtime injection, server-bootstrap adoption,
...
4. **PRD 21** — continue Option A from current `main` (integrated through #261,
