...
| Privacy PG persistence bundle            | `createPrivacyPgPersistence` in `apps/api/src/privacy/pg-persistence.ts`                                              | Disposable PG evidence/audit/subject-request                     | Unit mock composition; synthetic seam only                     | Active |
