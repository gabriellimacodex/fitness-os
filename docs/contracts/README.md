...
| Onboarding invitation (disposable PG)   | `onboarding_invitation` table + repository in `packages/database`                                                     | Synthetic onboarding persistence                                 | Disposable PG tests; API still in-memory      | Active |
