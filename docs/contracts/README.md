...
| Onboarding operation (disposable PG)    | `onboarding_operation` table + repository in `packages/database`                                                      | Synthetic onboarding idempotency                                 | Disposable PG tests; append-only put/replay; API still in-memory | Active |
