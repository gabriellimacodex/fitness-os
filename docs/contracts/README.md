...
| -----------------------------------------   | -------------------------------------------------------------------------------------------------------------------------------              | --------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------- | ------ |
| Onboarding transition (disposable PG)       | `onboarding_transition` table + sink in `packages/database` (migration `0014_prd07_onboarding_transition`)                                   | Synthetic onboarding transition evidence                                          | Disposable PG tests; append-only, dedup on exact-tuple repeat; API still in-memory `SyntheticOnboardingTransitionSink` | Active |
