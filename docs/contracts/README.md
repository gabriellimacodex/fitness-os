...
| Onboarding principal binding                 | `PrincipalBindingRepository` + `SyntheticPrincipalBindingRepository` in `@fitness-os/domain`                                   | Domain onboarding ports                                                           | Unit tests; denies synthetic_in_production; PG via `asPrincipalBindingRepository` | Active |
