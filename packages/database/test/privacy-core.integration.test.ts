  ...
  () => {
    ...
    beforeEach(async () => {
      await connection.db.execute(
        sql`TRUNCATE privacy_governance_lifecycle_proof, privacy_processor_execution_journal, privacy_processor_step, privacy_subject_request_transition, privacy_subject_request, privacy_audit_event, privacy_withdrawal, privacy_authorization_evidence, privacy_purpose_version, privacy_processor_registration, privacy_policy_package_version`,
      );
    });
